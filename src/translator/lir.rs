...
pub struct LirContext {
    ...
    pub block_to_function: HashMap<BlockId, BlockId>,
    pub register_to_function: HashMap<usize, BlockId>,

    pub blocks: Vec<LirBlock>,

    stack_offsets: HashMap<StackSlot, i64>,
    pub frame_sizes: HashMap<BlockId, i64>,
    ...
    pub restore_data_registers: Vec<LirOperand>,
    pub restore_address_registers: Vec<LirOperand>,

    heap_pointer: LirOperand,
    pub frame_pointer: LirOperand,
    pub stack_pointer: LirOperand,

    pub allocated_data_registers: HashMap<usize, u8>,
    pub allocated_address_registers: HashMap<usize, u8>,

    pub spilled_data_registers: HashMap<usize, i64>,
    pub spilled_address_registers: HashMap<usize, i64>,
